            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SettingsMenuTile(icon: Iconsax.shopping_cart, title: 'My Addreses', subTitle: 'Add, remove products and move to checkout'),
                  const SettingsMenuTile(icon: Iconsax.bag_tick, title: 'My Addreses', subTitle: 'In-progress and Completed Orders'),
                  const SettingsMenuTile(icon: Iconsax.bank, title: 'My Addreses', subTitle: 'Withdraw balance to registered bank account'),
                  const SettingsMenuTile(icon: Iconsax.discount_shape, title: 'My Addreses', subTitle: 'List of all the discounted coupons'),
                  const SettingsMenuTile(icon: Iconsax.notification, title: 'My Addreses', subTitle: 'Set any kind of notification message'),
                  const SettingsMenuTile(icon: Iconsax.security_card, title: 'My Addreses', subTitle: 'Manage data usage and connected accounts'),
