        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              //Title & Sub Title
              Text(ConstantTexts.confirmEmail, style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
              const SizedBox(height: ConstantSizes.spaceBetweenItems),
              Text(email ?? '', style: Theme.of(context).textTheme.labelLarge, textAlign: TextAlign.center),
              const SizedBox(height: ConstantSizes.spaceBetweenItems),
              Text(ConstantTexts.confirmEmailSubTitle, style: Theme.of(context).textTheme.labelMedium, textAlign: TextAlign.center),
              const SizedBox(height: ConstantSizes.spaceBetweenSections),
              ...
              const SizedBox(height: ConstantSizes.spaceBetweenItems),
              SizedBox(width: double.infinity, child: TextButton(onPressed: () => controller.sendEmailVerification(), child: const Text(ConstantTexts.resendEmail))),
            ],
          ),
        )
      )
